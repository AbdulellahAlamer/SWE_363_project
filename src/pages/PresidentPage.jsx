        ...
        <div className="mb-12">
          ...
          <SectionCard className="flex gap-8 items-center">
            <div className="flex-1">
              ...
              <Button className="w-full bg-blue-600 text-white" onClick={() => setQrGenerated(true)}>Generate QR</Button>
            </div>
            <div className="flex-1 flex flex-col items-center">
              <div className="w-40 h-40 flex items-center justify-center rounded-2xl border-2 border-dashed border-blue-200 bg-[#f5f7fe] mb-2">
              ...
              <div className="flex gap-4">
                <Button variant="outline" className="text-blue-600 border-blue-600" disabled={!qrGenerated}>Download QR</Button>
                <Button variant="ghost" className="text-blue-600" disabled={!qrGenerated}>Copy Link</Button>
              </div>
            </div>
          </SectionCard>
        </div>
            ...
            {sampleEvents.slice(0, 3).map(ev => (
              <div key={ev.id} className="flex flex-col bg-white rounded-2xl shadow p-6">
                ...
                <div className="flex gap-2 mb-2">
                  <Button variant="secondary" className="w-1/2">Edit</Button>
                  <Button variant="outline" className="w-1/2 text-red-600 border-red-200">Delete</Button>
                </div>
                <Button variant="ghost" className="w-full border border-blue-200 text-blue-600">Notify</Button>
              </div>
            ))}
          </div>
        </div>
